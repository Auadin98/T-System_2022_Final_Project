...
public class HospitalBedsServiceREST implements HospitalBedsService {
    ...
    public void addHosBeds(HospitalBeds hospitalBeds) {
             restTemplate.postForEntity(url+"/hospitals", hospitalBeds, HospitalBeds.class);
        }
    ...
    public List<HospitalBeds> getHosBeds() {
       return Arrays.asList(restTemplate.getForEntity(url+"/hospitals/", HospitalBeds[].class).getBody());
    }
