...
public class SlovakiaHospitalPatients {
    ...
    public SlovakiaHospitalPatients(long id, Date oldest_reported_at, Date newest_reported_at, Date published_on, int ventilated_covid, int non_covid, int confirmed_covid, int suspected_covid, Date updated_at) {
        this.id = id;
