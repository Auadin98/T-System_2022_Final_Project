...
public class HospitalBeds {
    ...
    public HospitalBeds(long id, Date reported_at, Date updated_at, Date published_on, int capacity_all, int free_all, int capacity_covid, int occupied_jis_covid, int occupied_oaim_covid, int occupied_o2_covid, int occupied_other_covid) {
        this.id = id;
        this.reported_at = reported_at;
        this.updated_at = updated_at;
        this.published_on = published_on;
